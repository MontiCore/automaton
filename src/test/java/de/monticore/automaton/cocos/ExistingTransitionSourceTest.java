...
public class ExistingTransitionSourceTest extends AbstractTest {
  ...
  public void testValid() throws IOException {
    ModelPath modelPath = new ModelPath(
        Paths.get("src/test/resources/de/monticore/automaton/cocos/valid"));
  ...
  public void testNotExistingTransitionSource() throws IOException {
    ASTTransition transition =
        parseModel(
            "src/test/resources/de/monticore/automaton/cocos/invalid/NotExistingTransitionSource.aut")
